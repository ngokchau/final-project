...
<?php
	...
	protected function html5_comment( $comment, $depth, $args ) {
		$tag = ( 'div' === $args['style'] ) ? 'div' : 'li';
?>
		<<?php echo $tag; ?> class="media" id="comment-<?php comment_ID(); ?>" <?php comment_class( empty( $args['has_children'] ) ? '' : 'parent' ); ?>>
			<article id="div-comment-<?php comment_ID(); ?>" class="media comment-body">
				...
				<div class="media-body">
					<h5 class="media-heading">
						...
						<!-- <a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>" class="media-heading">
